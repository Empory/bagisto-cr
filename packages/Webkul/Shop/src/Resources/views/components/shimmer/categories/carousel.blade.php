...
<div class="container mt-[60px] max-lg:px-[30px] max-sm:mt-[20px]">
    <div class="relative">
        <div class="flex flex-wrap gap-10 overflow-auto scrollbar-hide max-sm:gap-4">
            @for ($i = 0;  $i < $count; $i++)
                <div class="grid grid-cols-1 gap-[15px] justify-items-center min-w-[120px]">
                    <div class="shimmer relative w-64 h-96 overflow-hidden rounded-md">
                        <img class="bg-[#F5F5F5] w-full">
                    </div>
